...
public record FunctionalGoalDto(
    Guid Id, Guid PatientId, Guid AuthorId, string FunctionalLimitation, string FunctionalTask,
...
public record CreateGoalRequest(
    Guid PatientId, string FunctionalLimitation, string FunctionalTask,
