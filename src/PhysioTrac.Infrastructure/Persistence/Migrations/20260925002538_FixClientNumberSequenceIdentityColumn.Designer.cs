...
namespace PhysioTrac.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925002538_FixClientNumberSequenceIdentityColumn")]
    partial class FixClientNumberSequenceIdentityColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.AppointmentSeries", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppointmentSeries");
                });

            modelBuilder.Entity("PhysioTrac.Domain.Entities.AppointmentStatusHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.AppointmentType", b =>
                {
                    ...
                    b.Property<string>("DefaultCptCode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.ClinicalNote", b =>
                {
                    ...
                    b.Property<DateOnly?>("PlanOfCareCertifiedDate")
                        .HasColumnType("date");

                    b.Property<Guid?>("PlanOfCareCertifyingProviderId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("SignatureCredentials")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.ClinicalNoteVersion", b =>
                {
                    ...
                    b.Property<bool>("IsSignedVersion")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("ClinicalNoteVersions");
                });

            modelBuilder.Entity("PhysioTrac.Domain.Entities.Consent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PatientId", "ConsentType", "SignedAt");

                    b.ToTable("Consents");
                });

            modelBuilder.Entity("PhysioTrac.Domain.Entities.ConsentTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OrganizationId", "ConsentType", "Scope", "State", "LocationId", "IsActive");

                    b.ToTable("ConsentTemplates");
                });

            modelBuilder.Entity("PhysioTrac.Domain.Entities.CptCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.CptCodeMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("InterventionCategory")
                        .IsRequired()
                        .HasMaxLength(32)
                    ...
                    b.HasIndex("OrganizationId", "InterventionCategory", "IsActive");

                    b.ToTable("CptCodeMappings");
                });
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.DocumentShareLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.HomeExerciseProgram", b =>
                {
                    ...
                    b.Property<Guid?>("DiscontinuedById")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("HomeExercisePrograms");
                });

            modelBuilder.Entity("PhysioTrac.Domain.Entities.IntakeFormSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("IntakeFormTemplateId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("IntakeFormTemplateId");
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.IntakeFormTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.Organization", b =>
                {
                    ...
                    b.Property<string>("EightMinuteRuleVariant")
                        .IsRequired()
                        .HasMaxLength(24)
                        .HasColumnType("nvarchar(24)");
                    ...
                    b.Property<int?>("ProgressNoteDueDays")
                        .HasColumnType("int");

                    b.Property<int?>("ProgressNoteDueVisitCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.PatientAllergy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.PatientDiagnosis", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.PatientDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.PatientMedication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.PayerFeeScheduleItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PayerId", "CptCode")
                        .IsUnique();

                    b.ToTable("PayerFeeScheduleItems");
                });
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.ProviderLicense", b =>
                {
                    ...
                    b.Property<bool>("IsCompactPrivilege")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("ProviderId", "State", "LicenseNumber")
                        .IsUnique();

                    b.ToTable("ProviderLicenses");
                });
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.ReferringProvider", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ReferringProviders");
                });

            modelBuilder.Entity("PhysioTrac.Domain.Entities.Room", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.ServicePrice", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "LocationId", "CptCode")
                        .IsUnique()
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("PhysioTrac.Domain.Entities.Room", "Room")
                        .WithMany()
                        .HasForeignKey("RoomId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("PhysioTrac.Domain.Entities.AppointmentSeries", "Series")
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.ClinicalNote", b =>
                {
                    ...
                    b.HasOne("PhysioTrac.Domain.Entities.ReferringProvider", "PlanOfCareCertifyingProvider")
                        .WithMany()
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.IntakeFormSubmission", b =>
                {
                    b.HasOne("PhysioTrac.Domain.Entities.IntakeFormTemplate", "IntakeFormTemplate")
                        .WithMany()
                        .HasForeignKey("IntakeFormTemplateId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("IntakeFormTemplate");
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.Patient", b =>
                {
                    ...
                    b.HasOne("PhysioTrac.Domain.Entities.ReferringProvider", "PrimaryCareProvider")
                        .WithMany()
                        .HasForeignKey("PrimaryCareProviderId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("PhysioTrac.Domain.Entities.Location", "PrimaryLocation")
                        .WithMany()
                        .HasForeignKey("PrimaryLocationId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("PhysioTrac.Domain.Entities.ReferringProvider", "ReferringProvider")
                        .WithMany()
            ...
            modelBuilder.Entity("PhysioTrac.Domain.Entities.PatientDiagnosis", b =>
                {
                    b.HasOne("PhysioTrac.Domain.Entities.DiagnosisCode", "DiagnosisCode")
                        .WithMany()
