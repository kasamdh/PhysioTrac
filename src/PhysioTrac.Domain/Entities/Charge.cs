...
public class Charge : BaseEntity
{
    ...
    /// <summary>Set only when this charge was generated by
    /// IChargeService.GenerateFromAppointmentAsync's flat per-visit path --
    /// null for both manually entered charges and ones generated from a
    /// note's interventions (which link via ClinicalNoteId instead). Also
    /// how GenerateFromAppointmentAsync detects "already generated for this
    /// appointment" and refuses to duplicate.</summary>
